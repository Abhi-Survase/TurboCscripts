...
float ang1=3.839724354,ang2=5.585053606, c1=0.05,c2=-0.05,var1=2.967059728,var2=5.410520681,d1=0.072,d2=-0.072,s=2.35619449;
initgraph(&driver,&mode,"C:\\Turboc3\\BGI");
printf("Enter the number of rounds");
scanf("%d",&k);printf("Enter 1 for fast speed or 2 for normal speed");scanf("%d",&speed);
...
if(ang1>=5.585053606){c1=-0.05;var1=5.410520681;d1=-0.072;a=x11+10;s=2.35619449;}
